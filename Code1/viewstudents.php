...
<body style=  "background-image: url(https://wallpaperaccess.com/full/6891669.jpg); background-attachment:fixed">
<div class="container">
	...
	<div class="alert alert-warning col-lg-7 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-0 col-sm-offset-1 col-xs-offset-0" style="margin-top:140px; font-size: 20px">
	    ...
	    <strong style="font-size: 23px">Student Table</strong> 
        </h4>
	</div>


	</div>
	<div class="container col-lg-11 " style = "margin-left: 65px">
