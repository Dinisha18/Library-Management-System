<?php 
   ...
   ?>
   <body style=  "background-image: url(https://static.vecteezy.com/system/resources/previews/002/833/729/large_2x/blue-geometric-shape-gradient-background-free-vector.jpg); background-repeat: no repeat">
<div class="container" style = "margin-top: 80px">
   ...
   <div class="container  col-lg-9 col-md-11 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 col-xs-offset-0  " style="margin-top: 20px">
      <div class="jumbotron login col-lg-10 col-md-11 col-sm-12 col-xs-10">
         ...
         <?php } ?>
         <p class="page-header" style="text-align: center; margin-top: 10px"><b>ADD STUDENT</b></p>
         <div class="container">
            <form class="form-horizontal" role="form" action="addstudent.php" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <input type="text" class="form-control" name="studentId" placeholder="Registration Number" id="id_no" required>
                  </div>
               </div>
               <div class="form-group">
