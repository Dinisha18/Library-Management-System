<?php 
   ...
   ?>
   <body style=  "background-image: url(https://static.vecteezy.com/system/resources/previews/002/833/729/large_2x/blue-geometric-shape-gradient-background-free-vector.jpg); background-attachment:fixed">
<div class="container" style = "margin-top: 120px">
   <?php include "includes/nav.php"; ?>
   <div class="container  col-lg-9 col-md-11 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 col-xs-offset-0  " style="margin-top: 10px">
      <div class="jumbotron login col-lg-10 col-md-11 col-sm-12 col-xs-12">
         <p class="page-header" style="text-align: center; margin-top: 10px">LEND BOOK</p>
         <div class="container">
