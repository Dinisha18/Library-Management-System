<?php 
   ...
   ?>
   <body style=  "background-image: url(https://wallpaper.dog/large/10928757.jpg); background-attachment:fixed">
<div class="container">
   ...
   <h4 class="center-block"><span class="glyphicon glyphicon-book"></span><Strong Style="font-size: 23px"> Admins</Strong></h4>
   </div>
</div>
<div class="container">
