...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <img src="https://assets.webiconspng.com/uploads/2016/12/User-Icon.png" alt="All books" style="width:50px; height:50px; margin-left: 1098px; opacity:0.9; border-radius: 8px; margin-top: 8px">
        ...
        <div class="collapse navbar-collapse" id="bs-example">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a style="font-size: 22px; font-family: 'Bebas Neue', cursive; margin-left: 975px"  href="logout.php">Logout</a></li>
            </ul>
        </div>
    </div>
</nav>